...
public class ControllerGenerator {
    ...
    public static void generate(Class<?> clazz) throws IOException {
        ...
        Path path = Paths.get("", "src\\main\\java\\com\\lnet\\tms\\web", packageName, clazz.getSimpleName() + "Controller.java");
        ...
        try {
            GeneratorUtils.generate("controller.ftl", destFile, model);
        } catch (IOException e) {
            e.printStackTrace();
