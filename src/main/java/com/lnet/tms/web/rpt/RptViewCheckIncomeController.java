...
@Controller
@RequestMapping("/rptViewCheckIncome")
public class RptViewCheckIncomeController extends CrudController<RptViewCheckIncome, UUID, RptViewCheckIncomeService> {

    @Autowired
    private HibernateAwareObjectMapper mapper;
    @Autowired
    public void setBaseService(RptViewCheckIncomeService service) {
        super.setService(service);
    }

    @RequestMapping(method = RequestMethod.GET)
    @RequiresPermissions("ORDERCHECKINCOME_SELECT")
    public String index() {
      return "rpt/rptViewCheckIncome/index";
    }

    @RequestMapping("/incomeCheck")
    public String incomeCheck() {
        return "rpt/rptViewCheckIncome/incomeCheckIndex";
    }
    ...
    public String modify(@RequestParam("id") UUID id, ModelMap model) throws JsonProcessingException {
        ...
        return "rpt/rptViewCheckIncome/modify";
    }
