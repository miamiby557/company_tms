...
<script>
    function ModifyModel() {
        var self = this;
        self.model = {};
        self.model = ko.mapping.fromJS(${scmCarrierQuoteJson});
        ...
        self.save = function () {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json",
                url: "/scmCarrierQuote/updateScmCarrierQuote",
    ...
    $(function () {
        ...
        var modifyModel = new ModifyModel();
        ko.applyBindings(modifyModel, document.getElementById("quote-modify-form"));
    });
