...
<script>
    var GridModel = function () {
        ...
        self.dataSource = kendo.utils.createDataSource("clientPickupAddressId", "/crmClientPickupAddress/getDateSource?clientId=${crmClient.clientId}");
        ...
        self.add = function () {
            var url = "crmClientPickupAddress/create/${crmClient.clientId}";
            modal("新增", url, {
        ...
        self.modify = function () {
            var selectedId = self.selected().clientPickupAddressId;
            var url = "crmClientPickupAddress/modify/" + selectedId;
            modal("新增", url, {
                width: 400, height: 400, close: function () {
                    self.dataSource.query();
                }
        ...
        self.remove = function () {
            ...
            $.ajax({
                ...
                url: "/crmClientPickupAddress/deleteById",
