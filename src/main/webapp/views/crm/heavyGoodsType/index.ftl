...
<script>
    var gridModel = function () {
        ...
        self.dataSource = kendo.utils.createDataSource("heavygoodsTypeId", "/baseHeavygoodsType/dataSource?clientId=${crmClient.clientId}");
        ...
        self.add=function(){
            var url="baseHeavygoodsType/create/${crmClient.clientId}";
            modal("新增", url, {
