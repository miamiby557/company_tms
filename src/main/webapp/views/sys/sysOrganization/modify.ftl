<ol class="breadcrumb">
    ...
    <li><a href="#/sysOrganization/modify/${sysOrganization.organizationId}"><i class="fa fa-plus"></i> 增加</a></li>
</ol>
    ...
    <form id="organization-form" method="post" data-bind="submit:save" class="form-horizontal">
        <div data-bind="with:model">
            ...
            <div class="form-group">
                ...
                value:superiorOrganizationId,loadUrl:'/sysOrganization/'}"  />-->
                <input id="superiorOrganizationId" data-bind="kendoDropDownTreeView:{valueField: 'organizationId',textField: 'name',treeView:$root.treeViewOrganization,
...
<script>
    function SysOrganizationCreateModel() {
        ...
        self.model = {};
        self.model = ko.mapping.fromJS(${sysOrganizationJson});
        self.model.superiorOrganizationId = ko.observable("${sysOrganization.superiorOrganizationId}");
