    ...
    <form id="setting-form" method="post" data-bind="submit:save" class="form-horizontal">
        <div data-bind="with:model">
            <div class="form-group">
                ...
                <input type="text" class="k-input k-textbox" name="name" id="name" data-bind="value:name"  disabled="disabled">
            </div>
            <div class="form-group">
...
<script>
    function sysSettingCreateModel() {
        ...
        self.model = ko.mapping.fromJS(${sysSettingJSON});
