...
<script>
    function CreateModel() {
        var self = this;
        self.model={};
        self.model.carrierOrderId = ko.observable("${carrierOrderId}");
        self.model1=ko.mapping.fromJS(${otdCarrierOrderLog});
        ...
        self.otdCarrierOrders = kendo.utils.createListDataSource("carrierOrderId", "/otdCarrierOrder/getDataSource");
        self.save = function () {
            // 检查表单是否通过验证
