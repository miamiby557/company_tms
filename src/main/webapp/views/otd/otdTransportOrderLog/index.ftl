...
<ol class="breadcrumb">
    ...
    <li><a href="#/otdTransportOrderLogView"><i class="fa fa-users"></i> 运输订单信息跟踪</a></li>
    <li><a href="#/otdTransportOrderLog/index/${transportOrderId}"><i class="fa fa-users"></i> 运输订单日志</a></li>
</ol>

<div id="grid-wrap">
    <div class="grid-toolbar">
        <div>
            <a data-role="button" href="#/otdTransportOrderLogView"> <i class="fa fa-close"></i> 返回 </a>
            <a data-role="button" href="#/otdTransportOrderLog/create/${transportOrderId}"> <i class="fa fa-plus"></i> 增加 </a>
        ...
        <div>
            ...
            <@utils.koDropDown data="orderStatuss" value="currentStatus" />
...
<script>
    $(function () {
        var RoleGridModel = function () {
            ...
            self.dataSource = kendo.utils.createDataSource("transportOrderLogId", "/otdTransportOrderLog/dataSource?transportOrderId=${transportOrderId}");
            ...
            self.orderStatuss=commonData.orderStatus;
            ...
            self.modify = function () {
                ...
                var url = "#/otdTransportOrderLog/modify/" + dataItem.transportOrderLogId;
                router.navigate(url);
            };
            self.remove = function () {
                ...
                rows.each(function (i, row) {
                    ...
                    if (dataItem) {
                        ...
                        selectedIds.push(dataItem.transportOrderLogId);
                    }
                });
                ...
                $.ajax({
                    ...
                    url: "/otdTransportOrderLog/batchDeleteById",
