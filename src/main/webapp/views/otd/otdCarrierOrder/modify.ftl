...
<ol class="breadcrumb">
    ...
    <li><a href="#/otdCarrierOrder/modify/${otdCarrierOrder.carrierOrderId}"><i class="fa fa-edit"></i> 修改托运单</a></li>
</ol>
...
<div>
    <form id="modify-form" method="post" data-bind="submit:save" class="form-horizontal">
        <div class="col-6" data-bind="with:model">
            <div class="form-group">
                ...
                <input type="text" class="k-input k-textbox" name="carrierOrderNumber" id="carrierOrderNumber"
                       data-bind="value:carrierOrderNumber" required="required" maxlength="50" >
            </div>
            <div class="form-group">
        ...
        , dataTextField: 'name',filter: 'contains',dataValueField:'carrierId', change:$root.carrierChange }"/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea id="consigneeAddress" name="consigneeAddress" data-bind="value:consigneeAddress"
                          required="required" class="k-textbox" rows="5"></textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" class="k-input k-textbox" readonly="true" name="receiptPageNumber"
                       id="receiptPageNumber" data-bind="value:receiptPageNumber">
            </div>
            <div class="form-group">
        ...
        <div class="col-6" data-bind="with:model">
            ...
            <div class="form-group">
                ...
                <input type="number" class="k-input k-textbox" name="totalVolume" id="totalVolume"
                       data-bind="value:totalVolume" required="required" maxlength="25" readonly="true">
            </div>
            <div class="form-group">
                <label for="totalWeight">总重量</label>
                <input type="number" class="k-input k-textbox" name="totalWeight" id="totalWeight"
                       data-bind="value:totalWeight" readonly="true">
            </div>
            <div class="form-group">
                <label for="totalItemQuantity">总商品数量</label>
                <input type="number" class="k-input k-textbox" name="totalItemQuantity" id="totalItemQuantity"
                       required="required" data-bind="value:totalItemQuantity" readonly="true">
            </div>
            <div class="form-group">
                <label for="totalPackageQuantity">总件数</label>
                <input type="number" class="k-input k-textbox" name="totalPackageQuantity" id="totalPackageQuantity"
                       required="required" data-bind="value:totalPackageQuantity" readonly="true">
            </div>
            <div class="form-group">
...
<script>
    ...
    $(function () {
        jQuery.validator.methods.numberCheck =function(value,element,params){
            ...
            var result = true;
            var url  = "/otdCarrierOrder/carrierOrderNumberIsExist?carrierOrderId=${otdCarrierOrder.carrierOrderId}&carrierId="+carrierId+"&carrierOrderNumber="+value;
            $.ajax({
                type:"GET",
                contentType: "application/json",
                async:false,
