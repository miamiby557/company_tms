...
<ol class="breadcrumb">
    ...
    <li><a href="#/otdCarrierOrder/modify/${otdCarrierOrder.carrierOrderId}"><i class="fa fa-edit"></i> 发运</a></li>
</ol>
    ...
    <form id="modify-form" method="post" data-bind="submit:save" class="form-horizontal">
        <div class="col-6" data-bind="with:model">
            <div class="form-group">
                ...
                <input type="text" class="k-input k-textbox" name="carrierOrderNumber" id="carrierOrderNumber" data-bind="value:carrierOrderNumber" required="required" maxlength="50" >
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="k-input k-textbox" name="goodsName" id="goodsName" data-bind="value:goodsName" maxlength="25">
            </div>
            <div class="form-group">
                <label for="receiptPageNumber">回单份数</label>
                <input type="number" class="k-input k-textbox" required="required" name="receiptPageNumber" id="receiptPageNumber" data-bind="value:receiptPageNumber">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="date" name="sendDate" required="required" id="sendDate" data-bind="kendoDateTimePicker:sendDate" required="required">
            </div>
            <div class="form-group">
                <label for="driver">司机</label>
                <input type="text" class="k-input k-textbox" name="driver" id="driver" data-bind="value:driver" maxlength="25">
            </div>
            <div class="form-group">
                <label for="driverPhone">司机电话</label>
                <input type="text" class="k-input k-textbox" name="driverPhone" id="driverPhone" data-bind="value:driverPhone" maxlength="25"
                        >
            </div>
            <div class="form-group">
                <label for="carType">车型</label>
                <input type="text" class="k-input k-textbox" name="carType" id="carType" data-bind="value:carType" maxlength="25">
            </div>
            <div class="form-group">
                <label for="carNumber">车牌号码</label>
                <input type="text" class="k-input k-textbox" name="carNumber" id="carNumber" data-bind="value:carNumber" maxlength="25">
            </div>
        </div>
        ...
        <div class="col-6" data-bind="with:model">
            <div class="form-group">
                ...
                <input type="number" class="k-input k-textbox" name="totalVolume" id="totalVolume" readonly="true" data-bind="value:totalVolume" required="required" maxlength="25">
            </div>
            <div class="form-group">
                <label for="totalWeight">总重量</label>
                <input type="number" class="k-input k-textbox" name="totalWeight" id="totalWeight" readonly="true" required="required" data-bind="value:totalWeight">
            </div>
            <div class="form-group">
                <label for="totalItemQuantity">总商品数量</label>
                <input type="number" class="k-input k-textbox" name="totalItemQuantity" id="totalItemQuantity" readonly="true" required="required" data-bind="value:totalItemQuantity">
            </div>
            <div class="form-group">
                <label for="totalPackageQuantity">总件数</label>
                <input type="number" class="k-input k-textbox" name="totalPackageQuantity" id="totalPackageQuantity" readonly="true" required="required" data-bind="value:totalPackageQuantity">
            </div>
            <div class="form-group">
        ...
        <div class="clear">
            ...
            <div id="details-grid-wrap">
                <div data-bind="kendoGrid: {widget: $root.detailsGrid, data:  $root.detailsDataSource,sortable: true,
                editable:{ confirmation:false}, columns: $root.detailColumns,save:$root.gridChange ,remove:$root.gridRemove }"></div>
            </div>
        </div>
...
<script>
    function ModifyModel() {
        ...
        self.model.sendDate = ko.observable(kendo.parseDate(${defaultDate},"yyyy-MM-dd HH:mm:ss"));
