...
<ol class="breadcrumb">
    ...
    <li><a href="#/otdPickupOrder/confirm/${otdPickupOrder.pickupOrderId}"><i class="fa fa-edit"></i> 审单</a></li>
</ol>
    ...
    <form id="modify-form" method="post" data-bind="submit:save" class="form-horizontal">
        <div data-bind="with:model">
            ...
            <div class="form-group">
                ...
                <input type="number" class="k-input k-textbox"   name="confirmedTotalVolume" id="confirmedTotalVolume" data-bind="value:confirmedTotalVolume" required="required" maxlength="25">
            </div>
            <div class="form-group">
                <label for="confirmedTotalWeight">确认重量(千克)</label>
                <input type="number" class="k-input k-textbox"  name="confirmedTotalWeight" id="confirmedTotalWeight" data-bind="value:confirmedTotalWeight" >
            </div>
            <div class="form-group">
                <label for="confirmedTotalItemQty">确认数量</label>
                <input type="number" class="k-input k-textbox"  name="confirmedTotalItemQty" id="confirmedTotalItemQty" data-bind="value:confirmedTotalItemQty" pattern="^[1-9]\d*$">
            </div>
            <div class="form-group">
                <label for="confirmedTotalPackageQty">确认件数</label>
                <input type="number" class="k-input k-textbox" name="confirmedTotalPackageQty" id="confirmedTotalPackageQty" data-bind="value:confirmedTotalPackageQty" pattern="^[1-9]\d*$">
            </div>
...
<script>
    function ModifyModel() {
        ...
        self.model.confirmedTotalVolume=ko.observable("${otdPickupOrder.totalVolume}");
        self.model.confirmedTotalWeight=ko.observable("${otdPickupOrder.totalWeight}");
        self.model.confirmedTotalItemQty=ko.observable("${otdPickupOrder.totalItemQty}");
        self.model.confirmedTotalPackageQty=ko.observable("${otdPickupOrder.totalPackageQty}");
