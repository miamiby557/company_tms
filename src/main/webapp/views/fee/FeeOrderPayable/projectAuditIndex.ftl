...
<ol class="breadcrumb">
    ...
    <li><a href="#/feeOrderPayableView/projectAudit"><i class="fa fa-users"></i> 应付客服经理审核</a></li>
</ol>
<div id="grid-wrap">
...
<script>
    $(function () {
        var RoleGridModel = function () {
            ...
            self.dataSource = kendo.utils.createDataSource("orderPayableId", "/feeOrderPayableView/getProjectAuditDataSource");
            ...
            self.columns = [{
                ...
                title: "托运单",
                template: "<a href='\\#/feeOrderPayable/projectAudit/#= orderPayableId #' >#= carrierOrderNumber# </a>",
                width:120
            },{
                field: "startCity",
                title: "始发城市",
            ...
            self.canPass = ko.computed(function () {
                return true;// self.selected()&&self.selected().status==2;
            });
            ...
            self.pass = function () {
                ...
                $.ajax({
                    ...
                    url: "/feeOrderPayable/projectPassBatch",
