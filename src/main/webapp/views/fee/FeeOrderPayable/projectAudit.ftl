...
<ol class="breadcrumb">
    ...
    <li><a href="#/feeOrderPayable/projectAudit/${feeOrderPayableView.orderPayableId}"><i class="fa fa-plus"></i> 应付客服经理审核详情</a>
    </li>
</ol>
    ...
    function CreateModel() {
        ...
        self.pass=function(){
            ...
            $.ajax({
                ...
                url: "/feeOrderPayable/projectPass",
                data: ko.toJSON(orderPayableId)
            }).done(function (result) {
                if (result.success === true) {
                    notify("审核成功！", "success");
                    router.navigate("/feeOrderPayableView/projectAudit");
                }
                else {
        ...
        self.back=function(){
            var url = "feeOrderPayableLog/projectCreate/${feeOrderPayableView.orderPayableId}";
