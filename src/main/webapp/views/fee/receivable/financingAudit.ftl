...
<ol class="breadcrumb">
    ...
    <li><a href="#/feeOrderReceivable/financingAudit/${orderReceivable.orderReceivableId}"><i class="fa fa-plus"></i> 应收项目审核详情</a>
    </li>
</ol>
    ...
    <form id="modify-form" method="post"  class="form-horizontal">
        ...
        <div class="clear">
            ...
            <div id="details-grid-wrap">
                <div data-bind="kendoGrid: {widget: $root.detailsGrid, data: $root.detailsDataSource, sortable: true, editable:false, columns: $root.detailColumns, pageable:false,toolbar:$root.detailToolbar}"></div>
            </div>
        </div>
        ...
        <div class="clear">
            <h3>操作日志</h3>
            <div id="details-grid-wrap">
                <div data-bind="kendoGrid: {widget: $root.logsGrid, data: $root.logsDataSource, sortable: true, editable:false, columns: $root.logColumns,pageable:false, toolbar:$root.logToolbar }"></div>
            </div>
        </div>
...
<script>
    function CreateModel() {
        ...
        self.pass=function(){
            ...
            $.ajax({
                ...
                if (result.success === true) {
                    notify("操作成功！", "success");
                    router.navigate("/feeOrderReceivableView/financingAudit");
                }
                else {
        ...
        self.back=function(){
            var url = "feeOrderReceivableLog/financingCreate/${orderReceivable.orderReceivableId}";
        ...
        self.cancelFinish=function(){
            var url = "feeOrderReceivableLog/cancelFinish/${orderReceivable.orderReceivableId}";
