...
<script>
    $(function () {
        var RoleGridModel = function () {
            ...
            self.dataSource = kendo.utils.createDataSource("orderReceivableId", "/feeOrderReceivableView/getProjectAuditDataSource");
            ...
            self.columns = [{
                ...
                title: "客户单号",
                template: "<a href='\\#/feeOrderReceivable/projectAudit/#= orderReceivableId #' >#= clientOrderNumber# </a>",
                width:120
            }, {
                field: "orderDate",
                title: "订单日期",
