...
<ol class="breadcrumb">
    ...
    <li><a href="#/rpt"><i class="fa fa-users"></i> 信息跟踪报表</a></li>
</ol>

<div id="grid-wrap-informationTracking">
    ...
    <div data-bind="kendoGrid: { data: dataSource, widget: widget, columns: columns,sortable: true, groupable: true, toolbar:['excel','pdf'],editable:false, pageable: pageable, selectable: 'multiple,row',selectable: 'row'}"></div>
</div>
...
<script>
    $(function () {
        var RoleGridModel = function () {
            ...
            self.dataSource = kendo.utils.createDataSource("logId","/rptViewInformationTracking/getDataSource");
            ...
            self.columns = [{
                ...
                width: 120
                    ...
                    field: "transportOrderGoodsType",
                    title: "物料大类",
                    width: 180
                },{
                    field: "transportOrderGoodsCode",
                    title: "物料小类",
                    width: 180
                },{
                     field: "transportOrderGoodsName",
                    title: "物料明细",
                    width: 180
                },{
        ...
        ko.applyBindings(viewModel, document.getElementById("grid-wrap-informationTracking"));
    });
</script>