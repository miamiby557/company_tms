...
<ol class="breadcrumb">
    ...
    <li><a href="#/rptViewOtdMonthsum/crossProfit"><i class="fa fa-users"></i> 月毛利统计</a></li>
</ol>

<div id="grid-wrap-rptOrderNumber">
...
<script>
    ...
    $(function () {
        ...
        ko.applyBindings(viewModel, document.getElementById("grid-wrap-rptOrderNumber"));
    });
</script>