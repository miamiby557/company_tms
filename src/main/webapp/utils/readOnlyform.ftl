...
<div class="form-group">
    ...
    <input type="text" readonly="true" class="k-input k-textbox" name="${name}" id="${id}" data-bind="value:${field}"
...
<div class="form-group">
    <label for="${id}">${label}</label>
    <input type="number" readonly="true" class="k-input k-textbox" name="${name}" id="${id}" data-bind="value:${field}"
    <#list attributes?keys as attr>
    ${attr}="${attributes[attr]?html}"
    </#list>
    />
...
<div class="form-group">
    <label for="${id}">${label}</label>
    <input type="digits" readonly="true" class="k-input k-textbox" name="${name}" id="${id}" data-bind="value:${field}"
    <#list attributes?keys as attr>
    ${attr}="${attributes[attr]?html}"
    </#list>
    />
...
<div class="form-group">
    <label for="${id}">${label}</label>
    <textarea id="${id}" readonly="true" name="${name}" data-bind="value:${field}" class="k-textbox"
    <#list attributes?keys as attr>
    ${attr}="${attributes[attr]?html}"
    </#list>
    />
...
<div class="form-group">
    <input type="checkbox" readonly="true" id="${id}" name="${name}" data-bind="checked:${field}"
    <#list attributes?keys as attr>
    ${attr}="${attributes[attr]?html}"
    </#list>
    />
...
<div class="form-group">
    <label for="${id}">${label}</label>
    <input id="${id}" name="${name}" readonly="true"
...
<div class="form-group">
    <label for="${id}">${label}</label>
    <input type="number" readonly="true"  name="${name}" id="${id}" data-bind="kendoDatePicker:{value:${field}
    <#if dataEvent>,${dataEvent}</#if>
            }"
    <#list attributes?keys as attr>
    ${attr}="${attributes[attr]?html}"
...
<div class="form-group">
    <label for="${id}">${label}</label>
    <input type="number" readonly="true"  name="${name}" id="${id}" data-bind="kendoDateTimePicker:{value:${field}
    <#if dataEvent>,${dataEvent}</#if>
            }"
    <#list attributes?keys as attr>
    ${attr}="${attributes[attr]?html}"
